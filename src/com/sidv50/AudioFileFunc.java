...
public class AudioFileFunc {
    ...
    public final static int AUDIO_SAMPLE_RATE = 16000;//44100;  //44.1KHz,普遍使用的频率   
    //录音输出文件
    ...
    public static String getRawFilePath(){
        ...
        if(isSdcardExit()){
            ...
            mAudioRawPath = fileBasePath+"/msc/"+AUDIO_RAW_FILENAME;
        }   
    ...
    public static String getWavFilePath(){
        ...
        if(isSdcardExit()){
            String fileBasePath = Environment.getExternalStorageDirectory().getAbsolutePath();
            mAudioWavPath = fileBasePath+"/msc/"+AUDIO_WAV_FILENAME;
        }
